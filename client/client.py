...
def showImage(index):
    global my_img, lst_food, lst_image

    top = Toplevel()
    top.title('Ruki Restaurant')

    # Check index
    # lst_image = [filname.replace(" ", "") for filname in lst_food]
    # print(lst_image)
    # if index == 0:  # Default
    #     img = Image.open('camcui.jpg')
    # else:

    img = Image.open(lst_image[index])
    # img = Image.open('camcui.jpg')
...
def ViewMenuPage(root):
    ...
    button = Button(show_image_frame, text='+',
                    command=lambda: showImage(0), bd=1, bg="#FFFFFF")
    button.pack(side="top", fill='y', padx=0, pady=8)

    button1 = Button(show_image_frame, text='+',
                     command=lambda: showImage(1), bd=1, bg="#FFFFFF")
    button1.pack(side="top", fill='y', padx=0, pady=8)

    button2 = Button(show_image_frame, text='+',
                     command=lambda: showImage(2), bd=1, bg="#FFFFFF")
    button2.pack(side="top", fill='y', padx=0, pady=8)

    button3 = Button(show_image_frame, text='+',
                     command=lambda: showImage(3), bd=1, bg="#FFFFFF")
    button3.pack(side="top", fill='y', padx=0, pady=8)

    button4 = Button(show_image_frame, text='+',
                     command=lambda: showImage(4), bd=1, bg="#FFFFFF")
    button4.pack(side="top", fill='y', padx=0, pady=8)

    button5 = Button(show_image_frame, text='+',
                     command=lambda: showImage(5), bd=1, bg="#FFFFFF")
    button5.pack(side="top", fill='y', padx=0, pady=8)

    button6 = Button(show_image_frame, text='+',
                     command=lambda: showImage(6), bd=1, bg="#FFFFFF")
    button6.pack(side="top", fill='y', padx=0, pady=8)

    button7 = Button(show_image_frame, text='+',
                     command=lambda: showImage(7), bd=1, bg="#FFFFFF")
    button7.pack(side="top", fill='y', padx=0, pady=8)

    button8 = Button(show_image_frame, text='+',
                     command=lambda: showImage(8), bd=1, bg="#FFFFFF")
    button8.pack(side="top", fill='y', padx=0, pady=8)
...
def response():
    client.sendall("Received".encode('utf8'))


def receiveImage():
    # Receive image
    filename = client.recv(1024).decode()
    zipSize = int(client.recv(1024).decode())
...
receiveData()
receiveImage()
lst_image = [filname.replace(" ", "") + ".jpg" for filname in lst_food]
print(lst_image)
print(lst_food)
# Create root
root = init()
